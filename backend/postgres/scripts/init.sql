...
(
    ...
    CONSTRAINT fk705ekld71bk7mxigoulp78jsa FOREIGN KEY (blood_donor_id)
        REFERENCES public.blood_donors (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fkbmskfmg2d7gsx3mc78q3l3qxt FOREIGN KEY (blood_bank_id)
        REFERENCES public.blood_banks (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
(
    ...
    CONSTRAINT fkg9p442h7ngqji0jx333pep1wy FOREIGN KEY (appointment_id)
